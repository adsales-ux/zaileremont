          ...
          <Card>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                ...
                <p className="text-lg font-bold text-slate-700">{prices.perMbMin.toLocaleString('pl-PL')} zł</p>
                <p className="text-xs text-slate-400">za mb</p>
              </div>
              <div className="bg-blue-50 rounded-lg py-2">
                <p className="text-xs text-blue-500 uppercase">Mediana</p>
                <p className="text-xl font-bold text-blue-700">{prices.perMbMedian.toLocaleString('pl-PL')} zł</p>
                <p className="text-xs text-blue-400">za mb</p>
              </div>
              <div>
                <p className="text-xs text-slate-400 uppercase">Maksimum</p>
                <p className="text-lg font-bold text-slate-700">{prices.perMbMax.toLocaleString('pl-PL')} zł</p>
                <p className="text-xs text-slate-400">za mb</p>
              </div>
            </div>
          </Card>
